...
const faqData: FAQItem[] = [
  {
    question: 'Come funziona il lead di prova gratuito?',
    answer: 'Ti registri in 2 minuti e ricevi subito 1 lead di prova completo senza costi. Puoi scaricare i dati, vedere i contatti e testare la qualità prima di decidere se abbonarti.',
    category: 'usage'
  },
  {

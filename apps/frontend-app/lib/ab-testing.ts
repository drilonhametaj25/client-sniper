...
export const AD_LANDING_AB_TESTS: ABTestVariant[] = [
  ...
  },
  {
    ...
    config: {
      ...
      subheadline: 'Lead qualificati che convertono davvero. Risparmia il 95% sui costi di acquisizione rispetto a Google Ads. Prova con 1 lead di prova gratuito.',
  ...
  },
  {
    ...
    weight: 25,
    config: {
      headline: 'Prova Gratuita Disponibile',

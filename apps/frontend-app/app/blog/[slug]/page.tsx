  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 border-b dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 dark:text-white font-medium">{post.category}</span>
          </nav>
        </div>
      </div>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Content */}
        <div className="prose prose-lg dark:prose-invert max-w-none mb-12 markdown-content">
          <ReactMarkdown 
            components={{
              ...
              pre: ({children}) => (
                <pre className="bg-gray-900 dark:bg-gray-800 text-white p-4 rounded-lg overflow-x-auto my-4">
                  {children}
                </pre>
              ),
              a: ({href, children}) => (
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6 mb-12">
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">Come posso iniziare con TrovaMi?</h4>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">Quanto costano i lead aggiuntivi?</h4>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">I lead sono realmente qualificati?</h4>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              {relatedPosts.map((relatedPost: BlogPost) => (
                <Link key={relatedPost.slug} href={`/blog/${relatedPost.slug}`} className="group">
                  <article className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200 overflow-hidden">
                    <div className="p-4">
                      <span className="inline-block px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-100 rounded-full mb-2">
                        {relatedPost.category}
                      </span>
                      <h4 className="font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200 mb-2 line-clamp-2">
                        {relatedPost.title}
                      </h4>

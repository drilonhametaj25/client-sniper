...
export const metadata: Metadata = {
  ...
  description: 'Trova clienti potenziali analizzando siti web con problemi tecnici. Lead generation automatica per agenzie web, freelancer e consulenti SEO. Prova gratuita per iniziare.',
  keywords: [
    'lead generation',
    'trova clienti',
    'lead qualificati', 
  ...
  return (
    <html lang="it" className="h-full" suppressHydrationWarning>
      <head>
        ...
        />
        <noscript>
          {/* Pixel di tracciamento 1x1 invisibile: alt="" lo marca come
              decorativo, così gli screen reader lo ignorano */}
          <img
            height="1"
            width="1"
            alt=""

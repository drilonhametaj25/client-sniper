...
export const metadata: Metadata = {
  ...
  description: 'Scopri clienti con problemi tecnici sui loro siti web. Lead qualificati a partire da 0,33€ - 40x meno di Google Ads. Prova gratuita per iniziare.',
  keywords: [
    'trova clienti',
    'lead generation',
    'clienti pronti',
  ...
  twitter: {
    ...
    description: 'Lead qualificati a partire da 0,33€ - 40x meno di Google Ads. Prova gratuita per iniziare.',

// Twitter Card image generator per TrovaMi
// Genera automaticamente l'immagine di anteprima per Twitter
// Dimensioni: 1200x675px (ottimale per summary_large_image)

            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">Email Generale</h3>
                    <p className="text-gray-600 dark:text-gray-300">info@trovami.pro</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Risposta entro 24 ore</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">Supporto Tecnico</h3>
                    <p className="text-gray-600 dark:text-gray-300">support@trovami.pro</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Problemi tecnici e assistenza</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">Vendite e Partnership</h3>
                    <p className="text-gray-600 dark:text-gray-300">sales@trovami.pro</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Piani aziendali e collaborazioni</p>
                  </div>
                </div>
              </div>
            </div>
